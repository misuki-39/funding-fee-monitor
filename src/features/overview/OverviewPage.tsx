      ...
      <section className={`panel ${styles.hero}`}>
        <div>
          ...
          <p className="description">
            Compare live funding rates across OKX, Binance, Gate.io, Bitget, and Bybit. Filter near-term settlements and
            drill into individual contracts for cross-exchange detail.
          </p>
        </div>
